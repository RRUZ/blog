...
type
  ...
  ['{49353c9a-516b-11d1-aea6-00c04fb68820}']
    ...
    function WritePropertyValue(lHandle, lNumBytes: Longint; aData: PByte): HRESULT; stdcall;
    function ReadPropertyValue(lHandle, lBufferSize: Longint; out plNumBytes: Longint; aData: pbyte): HRESULT; stdcall;
...
type
  ...
  ['{b7b31df9-d515-11d3-a11c-00105a1f515a}']
    function Shutdown(uReason: Longint; uMaxMilliseconds: ULONG; pCtx: IWbemContext): HRESULT; stdcall;
  end;
...
type
  ...
  ['{6daf974e-2e37-11d2-aec9-00c04fb68820}']
    function CompileFile(FileName, ServerAndNamespace, User, Authority, Password: LPWSTR;
      lOptionFlags, lClassFlags, lInstanceFlags: Longint; var pInfo: WBEM_COMPILE_STATUS_INFO): HRESULT; stdcall;
    function CompileBuffer(buffSize: Longint; pBuffer: PByte; ServerAndNamespace, User, Authority, Password: LPWSTR;
      lOptionFlags, lClassFlags, lInstanceFlags: Longint; var pInfo: WBEM_COMPILE_STATUS_INFO): HRESULT; stdcall;
